...
/* split the domain according to the number of processors and initializes
 * necessary variables */
void init_parallel(
	int iproc,
    int jproc,
 ...
 * either in one step (pressure_comm, not perfectly gaussian solver) or in two
 * steps (pressure_comm1 and 2, gaussian solver) */
/* Exchanges pressure between neighboring processes */
